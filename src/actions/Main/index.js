...
export function setListUsers(payload) {
  return { type: ActionTypes.SET_LIST_USER, payload };
}

export function setListTempUsers(payload) {
  return { type: ActionTypes.SET_LIST_TEMP_USER, payload };
}
